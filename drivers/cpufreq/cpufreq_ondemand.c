...
#if defined (CONFIG_USA_MODEL_SGH_I727) || defined(CONFIG_USA_MODEL_SGH_T989) || defined(CONFIG_USA_MODEL_SGH_I717) ||defined(CONFIG_USA_MODEL_SGH_T769)
...
extern void set_lcd_MaxLimit();  // 200cd
extern void set_lcd_MaxLimit2(); // 180cd
extern void unset_lcd_MaxLimit();
#endif
void set_lmf_browser_state(bool onOff)
{
	if (onOff)
...
#if defined (CONFIG_KOR_MODEL_SHV_E160S) || defined (CONFIG_KOR_MODEL_SHV_E160K) || defined (CONFIG_KOR_MODEL_SHV_E160L) || defined(CONFIG_USA_MODEL_SGH_I717) || defined(CONFIG_JPN_MODEL_SC_05D)
								set_lcd_MaxLimit();  // 200cd
								//set_lcd_MaxLimit2(); // 180cd
#endif
							}
							else
							{
